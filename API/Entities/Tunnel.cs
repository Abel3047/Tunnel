...
namespace API.Entities
{
    public class Tunnel<T>:AbstractTunnel
    {
        ...
        public readonly int TunnelId; // It will be TunnelType+DateTime'0'userUniqueId'3'+random5digitnumber, needs to be public so it can be added to Connectives of others
